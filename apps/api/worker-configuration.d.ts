/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareBindings` (hash: dd457f1c55fb0804247759897d251015)
...
interface __BaseEnv_CloudflareBindings {
	...
	IP_IMAGES_PER_DAY: string;
	IMAGES_PER_MONTH: string;
	QUOTAS: DurableObjectNamespace<import("./src/index").QuotaCounter>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "MAX_UPLOAD_BYTES" | "IP_REQUESTS_PER_MINUTE" | "IP_IMAGES_PER_DAY" | "IMAGES_PER_MONTH">> {}
}
